defmodule TpkExamplesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TpkExamplesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TpkExamplesWeb.Gettext, "errors", msg, opts)
    end
  end
